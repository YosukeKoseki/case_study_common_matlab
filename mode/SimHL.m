...
agent.sensor    = MOTIVE(agent, Sensor_Motive(1,0, motive));
  agent.reference.time_varying = TIME_VARYING_REFERENCE(agent,{"gen_ref_saddle", ...
      {"freq",8,"orig",[1.5;1.5;1],"size",[1;1;0.2]},"HL"});
% agent.reference.time_varying = TIME_VARYING_REFERENCE(agent,{"gen_ref_circle",{"freq",10,"init",[0;0;1],"radius",1.3},"HL"});

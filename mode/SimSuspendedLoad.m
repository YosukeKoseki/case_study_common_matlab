...
agent(2).sensor.direct = DIRECT_SENSOR(agent(2), 0.002*0);%motiveとforloadに書き換えると実験と同じ条件でできる
...
run("ExpBase");
agent(2).cha_allocation.sensor = ["motive","direct"];

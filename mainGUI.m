...
clc
SimBaseMode = ["SimSuspendedLoad","SimVoronoi", "SimHL","SimHL_MEC","SimPointMass", "SimVehicle", "SimSuspendedLoad", "SimFHL", "SimFHL_Servo", "SimLiDAR", "SimFT", "SimEL", "SimMPC_Koopman"];
...
% Setting.mode = SimBaseMode(4); % SimHL_MEC

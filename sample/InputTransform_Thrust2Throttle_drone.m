function u_trans_param = InputTransform_Thrust2Throttle_drone(varargin)
    ...
    %% transmitter system
    u_trans_param.gain_tl =[600;600;600;60]; % gain : [roll pitch yaw throttle]' %不明[850;850;600;600] 4s[700;700;600;400] 複数機[700;700;600;200] 発掘[800;800;800;400]
    u_trans_param.th_offset_tl = 300;         % offset 3s[1021] 4s[900]　発掘[926]
    u_trans_param.gain = [800;800;800;60];

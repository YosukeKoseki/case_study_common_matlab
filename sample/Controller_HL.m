...
% Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([3000,2000,200,1]),[0.1],dt); % xdiag([100,10,10,1])
% Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([3000,2000,200,1]),[0.1],dt); % ydiag([100,10,10,1])
% Controller.F4=lqrd([0 1;0 0],[0;1],diag([200,1]),[0.1],dt);                       % ヨー角
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% 機体名：足柄 2025/11/25 高山チューニング %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,1]),[1],dt);                                % z
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([6000,3000,10,1]),[0.1],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([6000,3000,10,1]),[0.1],dt); % ydiag([100,10,10,1])
Controller.F4=lqrd([0 1;0 0],[0;1],diag([100,1]),[0.1],dt);                       % ヨー角
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

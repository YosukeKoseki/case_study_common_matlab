...
% 機体名：陸奥 2025/06/09 小関チューニング %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,1]),[1],dt);                                % z 
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([200,400,100,1]),[0.001],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([200,400,100,1]),[0.001],dt); % ydiag([100,10,10,1])
